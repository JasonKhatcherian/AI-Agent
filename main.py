...
def main():
    ...
    parser = argparse.ArgumentParser(description="Chatbot with tool execution")
    ...
    for _ in range(20):
        ...
        if response.function_calls:
            ...
            for function_call in response.function_calls:
                ...
                # IMPORTANT: extract ONLY valid FunctionResponsePart
    ...
    if args.verbose:
        ...
        print(f"Total Cumulative Prompt tokens: {p_token}")
        print(f"Total Cumulative Response tokens: {r_token}")
